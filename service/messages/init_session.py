...
class InitSession( Message ):
    def __init__( self , usercode='',password=None, date=None):
        self.next_message = [ '1010', #OrderHeader
                              '0199' # CloseSession
                              ]
    ...
    def __str__(  self  ):
        return messages['INIT_SESSION_CODE'] + messages['INIT_SESSION_SUBCODE' ] +  self.date.rjust(14,' ') + self.user_code.rjust(16,' ' ) + self.password.rjust( 8,' ' ) + messages['END_MESSAGE']

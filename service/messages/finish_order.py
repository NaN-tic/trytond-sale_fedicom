...
class FinishOrder( Message ):
    ...
    def __str__( self ):
        return messages['FINISH_ORDER_CODE'] + messages['FINISH_ORDER_SUBCODE'] + self.num_lines.rjust(4,'0') + self.total_amount.rjust(6,'0') + self.bonus.rjust(6,'0') + messages['END_MESSAGE']

...
class FinishOrder( Message ):
    ...
    def __str__( self ):
        return message['FINISH_ORDER_CODE'] + message['FINISH_ORDER_SUBCODE'] + self.numlines.rjust(4,'0') + self.total_amount.rjust(6,'0') + self.bonus.rjust(6,'0') + message[END_MESSAGE]

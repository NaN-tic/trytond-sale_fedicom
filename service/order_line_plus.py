...
class OrderLinePlus( Message ):
    def __init__( self, article_national_code=None, amount=None,bonus=None,line_discount=None ):
    ...
    def __str__( self ):
        return self.messages['ORDER_LINE_PLUS_CODE'] +  self.messages['ORDER_LINE_PLUS_SUBCODE'] +   self.article_code +  self.bunus.rjust(4,'0') +str(self.discount).rjust(4,'0' ) + self.messages['END_MESSAGE']
